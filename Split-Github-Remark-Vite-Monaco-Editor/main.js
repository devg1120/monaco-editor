...
const session = monaco.editor.createModel(markdown,'markdown');

editor = monaco.editor.create(placeholder, {
  //value: markdown,
  //language: "markdown",
  lineNumbers: "on",
...
editor2 = monaco.editor.create(document.getElementById("in2"), {
  //value: markdown,
  //language: "markdown",
  lineNumbers: "on",
  roundedSelection: true,
